<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminCombinacionesPermitidasWF.aspx.cs" Inherits="SoftLoans.AdminCombinacionesPermitidasWF" %>
...
<body>
    ...
    <form id="form1" runat="server">
            ...
            <div class="row g-2">
                <div class="col-md-2">
                    <div class="container">
                        <div class="row">
                            <div class="col g-1">
                                <asp:TextBox ID="TbID" runat="server" type="number" class="form-control" placeholder="ID Limite Jugada"></asp:TextBox>
                ...
                <div class="col-4 col-md-1">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col g-1">
                                <asp:TextBox ID="TbMontoLimite" runat="server" type="number" class="form-control" placeholder="$0" Width="90"></asp:TextBox>
        ...
        <div class="container table-responsive">
            <asp:GridView ID="GvCombinacion" runat="server" AutoGenerateColumns="False" Width="100%"
                CssClass="table table-responsive table-striped table-hover table-sm"
                DataKeyNames="CombinationID,Combination,LotteryName,GainAmount,Enabled,PlayTypeID"
                EmptyDataText="No se encontraron datos entre los limites establecidos!"
                AllowCustomPaging="True"
                ForeColor="#333333"
                GridLines="Horizontal">
                <Columns>
                    <asp:BoundField DataField="CombinationID" HeaderText="ID" />
                    <asp:BoundField DataField="Combination" HeaderText="Combinacion"/>
                    ...
                    <asp:BoundField DataField="playTypeName" HeaderText="Tipo de Jugada" />
                    <asp:BoundField DataField="GainAmount" HeaderText="Monto Ganancia" />
                    <asp:BoundField DataField="Enabled" HeaderText="Activo">
                        <HeaderStyle CssClass="ocultar-div-md" Wrap="False"></HeaderStyle>
                        <ItemStyle CssClass="ocultar-div-md" Wrap="False"></ItemStyle>
                    </asp:BoundField>
                    <asp:BoundField DataField="PlayTypeID" HeaderText="Id Tipo Jugada">                    
                        <HeaderStyle CssClass="d-none" Wrap="False"></HeaderStyle>
                        <ItemStyle CssClass="d-none" Wrap="False"></ItemStyle>
                    </asp:BoundField>
