<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminLimiteNumeroWF.aspx.cs" Inherits="SoftLoans.AdminLimiteNumeroWF" %>
...
<head>
    ...
    <title>Limite por Numeros</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <form id="form1" runat="server">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <%-- onserverclick="BtnActualizar_Click" --%>
                        <button runat="server" type="button" class="btn btn-danger" data-bs-dismiss="modal" onserverclick="BtnBorrar_Click">Continuar</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="ContendorCabecera" runat="server" class="container">
            ...
            <div class="row g-2">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col g-1">
                                ...
                                <asp:RegularExpressionValidator ID="REVId"
                ...
                <div class="col-md-2">
                    <div class="container">
                        <div class="row">
                            <div class="col g-1">
                                <asp:TextBox ID="TbNumero" runat="server" type="text" class="form-control" placeholder="Nombre"></asp:TextBox>
                ...
                <div class="col-md-3">
                    <div class="container">
                        <div class="row">
                            <div class="col g-1">
                                <asp:DropDownList ID="DropDownTipoJugada" runat="server" CssClass="btn btn-secondary" Width="100%" ToolTip="Seleccione Loteria">
                                </asp:DropDownList>
                            </div>
                ...
                <div class="col-4 col-md-2">
                    <div class="container">
                        <div class="row">
                            <div class="col g-1">
                                <button class="btn btn-primary" runat="server" onserverclick="BtnNuevo_Click">
                                    <b>
        ...
        <div id="ContenedorNuevo" runat="server" class="container" visible="false">
            <div class="row g-3">
                <div class="col-md-6">
                    <asp:TextBox ID="TbLimitNumberID" runat="server" class="form-control" placeholder="Id"
                        ReadOnly="true" Text=""></asp:TextBox>
                </div>
                <div class="col-md-6">
                    <asp:TextBox ID="TbNumeroNuevo" runat="server" class="form-control" placeholder="Numeros" MaxLength="20"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RFVNumeroNuevo" runat="server"
                        ControlToValidate="TbNumeroNuevo"
                        ErrorMessage="Campo obligatorio"
                        ForeColor="Red"
                        EnableClientScript="false">
                    </asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator ID="REVNumeroNuevo"
                        ControlToValidate="TbNumeroNuevo" runat="server"
                ...
                <div class="col-md-6">
                    <asp:TextBox ID="TbMontoLimite" runat="server" class="form-control" placeholder="Monto Limite $" MaxLength="50"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RFVMontoLimite" runat="server"
                        ControlToValidate="TbMontoLimite"
                        ErrorMessage="Campo obligatorio"
                        ForeColor="Red"
                        EnableClientScript="false">

                    </asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator ID="REVMontoLimite"
                        ControlToValidate="TbMontoLimite" runat="server"
                        ErrorMessage="Solo números"
                        ValidationExpression="\d+" ForeColor="Red"
                        EnableClientScript="false">
                    </asp:RegularExpressionValidator>
                ...
                <div class="col-md-6">
                    <asp:DropDownList ID="DropDownTipoJugadaNuevo" runat="server" CssClass="btn btn-secondary" Width="100%" ToolTip="Seleccione Loteria">
                    </asp:DropDownList>
                </div>
                <div class="col-md-6">
                    <asp:DropDownList ID="DropDownListEnabled" runat="server">
                        <asp:ListItem Text="Activo" Value="SI"></asp:ListItem>
                        <asp:ListItem Text="Desactivado" Value="NO"></asp:ListItem>
                    </asp:DropDownList>
                </div>
            </div>
            <div class="row align-items-stard">
                ...
                <div class="col g-4 align-self-start">
                    <button id="BtnBorrar" runat="server" class="btn btn-danger" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal">
                        <b>
        ...
        <br />
        <div id="ContenedorGrid" runat="server" class="container table-responsive">
            <asp:GridView ID="GvLimiteNumero" runat="server" AutoGenerateColumns="False" Width="100%"
                CssClass="table table-responsive table-striped table-hover table-sm"
                DataKeyNames="LimitNumberID,Enabled"
                EmptyDataText="No se encontraron datos entre los limites establecidos!"
                AllowCustomPaging="True"
                ForeColor="#333333"
                GridLines="Horizontal"
                OnSelectedIndexChanged="GvLimiteNumero_SelectedIndexChanged">
                <Columns>
                    <asp:BoundField DataField="LimitNumberID" HeaderText="ID" />
                    <asp:BoundField DataField="PlayTypeLotteryName" HeaderText="Jugada-Loteria" />
                    <asp:BoundField DataField="Numbers" HeaderText="Numero" />
                    <asp:BoundField DataField="LimitAmount" HeaderText="Monto Limite" />
                    ...
                    <asp:ButtonField ImageUrl="/Content/bootstrap-icons/icons/pencil-square.svg" Text="" CommandName="Select" HeaderText="Modif." ButtonType="Image">
                        <ControlStyle CssClass="btn btn-warning"></ControlStyle>
                        <HeaderStyle HorizontalAlign="Right" />
                        <ItemStyle CssClass="btn-warning" HorizontalAlign="Center" Width="100px"></ItemStyle>
                    </asp:ButtonField>
