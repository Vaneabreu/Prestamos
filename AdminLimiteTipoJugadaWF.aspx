<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminLimiteTipoJugadaWF.aspx.cs" Inherits="SoftLoans.AdminLimiteTipoJugadaWF" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container table-responsive">
            <asp:GridView ID="GvTipoJugada" runat="server" AutoGenerateColumns="False" Width="100%"
                ...
                DataKeyNames="LimitPlayTypeID,PlayTypeID,PlayTypeLotteryName,Enabled"
                EmptyDataText="No se encontraron datos entre los limites establecidos!"
                AllowCustomPaging="True"
                ForeColor="#333333"
                GridLines="Horizontal">
                <Columns>
                    <asp:BoundField DataField="LimitPlayTypeID" HeaderText="ID Limite Jugada" />
                    <asp:BoundField DataField="PlayTypeID" HeaderText="ID Jugada">
