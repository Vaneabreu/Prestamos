<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminUsuariosWF.aspx.cs" Inherits="SoftLoans.AdminUsuarios" %>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button runat="server" type="button" class="btn btn-danger" data-bs-dismiss="modal" onserverclick="BtnReiniciarBalance_Click">Continuar</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-2">
                ...
                <div class="col-md-3">
                    <div class="container">
                        <div class="row">
                            <div class="col g-1">
                                <asp:DropDownList ID="DropDownListEmpleado" runat="server" CssClass="btn btn-secondary" Width="100%" ToolTip="Seleccione Loteria">
                                </asp:DropDownList>
                            </div>
            ...
            <div class="row g-2">
                ...
                <div class="col-md-2">
                    <div class="container">
                        <div class="row">
                            <div class="col g-1">
                                <asp:TextBox ID="TbEmpleadoE" runat="server" type="text" class="form-control" placeholder="Empleado" ReadOnly="true"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-5 col-md-1">
                    <div class="container p-2">
                        <label for="inputIdFechaPago" class="form-label">Fecha-Pago</label>
                    </div>
                </div>
                <div class="col-7 col-md-3">
                    <input type="date" class="form-control" id="InputFechaPago" value="" runat="server" />
                </div>
                <div class="col-4 col-md-1">
                    <div class="col g-1">
                        <asp:TextBox ID="TbHora" runat="server" type="number" class="form-control" placeholder="H:00" Width="90"></asp:TextBox>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2"
                            ControlToValidate="TbHora" runat="server"
                            ErrorMessage="Solo se permiten números"
                            ValidationExpression="\d+" ForeColor="Red"
                            EnableClientScript="false">
                        </asp:RegularExpressionValidator>
                 ...
                 <div class="col-4 col-md-1">
                    <div class="col g-1">
                        <asp:TextBox ID="TbMinuto" runat="server" type="number" class="form-control" placeholder="M:00" Width="90"></asp:TextBox>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator3"
                            ControlToValidate="TbMinuto" runat="server"
                            ErrorMessage="Solo se permiten números"
                            ValidationExpression="\d+" ForeColor="Red"
                            EnableClientScript="false">
                        </asp:RegularExpressionValidator>
                ...
                <div class="row align-items-stard">
                    ...
                    <div class="col g-1">
                        <button id="BtnCancelar" runat="server" class="btn btn-primary" clientidmode="Static" onserverclick="BtnCancelar_Click">
                            <b>
                                <img src="/Content/bootstrap-icons/icons/x-circle.svg" alt="Bootstrap" width="22" height="22" /><i>
                                    Cancelar</i></b>
                        </button>
                    </div>
                    <div class="col g-1 align-self-start">
                        <button id="BtnReiniciarBalance"  type="button" data-bs-toggle="modal" data-bs-target="#exampleModal" onserverclick="BtnReiniciarBalance_Click" class="btn btn-success">
                            <b>
        ...
        <div id="ContendorD" runat="server" class="container table-responsive">
            <asp:GridView ID="GvUsuarios" runat="server" AutoGenerateColumns="False" Width="100%"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Name" HeaderText="Usuario" />
                    <asp:BoundField DataField="EmployeeName" HeaderText="Empleado">
                        <HeaderStyle CssClass="ocultar-div-md" Wrap="False"></HeaderStyle>
                        <ItemStyle CssClass="ocultar-div-md" Wrap="False"></ItemStyle>
                    </asp:BoundField>
                    <asp:BoundField DataField="LastLoginDate" HeaderText="Ult. Fecha" />
                    <asp:BoundField DataField="IsAdministrator" HeaderText="Admin." />
