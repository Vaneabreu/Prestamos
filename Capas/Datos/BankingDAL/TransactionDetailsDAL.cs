...
public class TransactionDetailsDAL
{
    ...
    public Boolean PaidCredit(int customerID, int gAmount, string user)
    {
        SqlConnection con = new SqlConnection();
        SqlParameter parametros;
        Boolean res = false;
    ...
    public List<TransactionDetailsDAL> TransactionDetailReportNumber()
    {
        ErrorCode = 0;
        ErrorDescription = "Successful";
        SqlConnection con = new SqlConnection();
