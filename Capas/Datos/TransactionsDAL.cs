...
public class TransactionsDAL
{
	...
	public Boolean Insert(LoginDAL loginDAL)
	{
		...
		try
		{
            ...
            parametros = cmd.Parameters.Add("@Discount", SqlDbType.Decimal);
            parametros.Value = Discount;
            if (CustomerID != 0)
            {
    ...
    public List<TransactionsDAL> Search(LoginDAL loginDAL,bool usedDate = false)
	{
        ErrorCode = 0;
        ErrorDescription = "Successful";
		SqlConnection con = new SqlConnection();
        ...
        try
        {
            ...
            if (dr.HasRows)
            {
                while (dr.Read())
                {
                    ...
                    transactionsDAL.codeName = dr.GetString(dr.GetOrdinal("CodeName"));
    ...
    public List<TransactionsDAL> SearchStadistic(LoginDAL loginDAL)
    {
        ErrorCode = 0;
        ErrorDescription = "Successful";
        SqlConnection con = new SqlConnection();
    ...
    public List<TransactionsDAL> SearchPayWin(LoginDAL loginDAL, bool usedDate = false)
    {
        ErrorCode = 0;
        ErrorDescription = "Successful";
        SqlConnection con = new SqlConnection();
        ...
        try
        {
            dbm.DataSource = loginDAL.DataSource; dbm.DataBase = loginDAL.DataBaseName; dbm.User = loginDAL.UserName; dbm.Password = loginDAL.UserPassword; con = dbm.getConexion(dbm);
            con.Open();
            SqlCommand cmd = new SqlCommand("TransactionsSearchPayWin", con);
    ...
    public Boolean ValidateLimitsForCombinations(LoginDAL loginDAL)
    {
        bool res = false;
        SqlConnection con = new SqlConnection();
        SqlParameter parametros;
    ...
    public Boolean ValidateLimitsForPlayTypes(LoginDAL loginDAL)
    {
        bool res = false;
        SqlConnection con = new SqlConnection();
        SqlParameter parametros;
    ...
    public Boolean CancelTicket(LoginDAL loginDAL)
    {
        bool res = false;
        SqlConnection con = new SqlConnection();
        SqlParameter parametros;
    ...
    public Boolean GetLastIDByUser(LoginDAL loginDAL)
    {
        bool res = false;
        SqlConnection con = new SqlConnection();
        SqlParameter parametros;
    ...
    public Boolean GetTransactionTotal(LoginDAL loginDAL)
    {
        bool res = false;
        SqlConnection con = new SqlConnection();
        SqlParameter parametros;
    ...
    public List<ReportEntity> SearchSummaryGroup(LoginDAL loginDAL)
    {
        ErrorCode = 0;
        ErrorDescription = "Successful";
        SqlConnection con = new SqlConnection();
