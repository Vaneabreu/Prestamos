...
function ImprimirAmortizacion() {
    ...
    printJS({
        printable: "DivAmortizacion",
        type: "html",

        header: '<h3 class="custom-h3">Tabla de Amortización</h3>',
        css: ['/Content/bootstrap.min.css', '/Content/print.min.css'],



        onPrintDialogClose: ImprimirAmortizacionCompletado
    });
}
function ImprimirAmortizacionCompletado() {

    document.getElementById("BtnProcesar").click(); return false;
}

function ImprimirListadoCuotas() {
    printJS({
        printable: "DivReporteCuotas",
        type: "html",

        header: '<h3 class="custom-h3">Listado de Cuotas</h3>',
        css: ['/Content/bootstrap.min.css', '/Content/print.min.css'],



        onPrintDialogClose: ImprimirListadoCuotasCompletado
    });
}
function ImprimirListadoCuotasCompletado() {
