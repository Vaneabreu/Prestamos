<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TicketsWinListWF.aspx.cs" Inherits="SoftLoans.TicketsWinListWF" %>
            ...
            <div class="row g-2">
                ...
                <div class="col-md-4">
                    <div class="col g-1">
                        ...
                        <button onserverclick="BtnImprimir_Click" runat="server" class="btn btn-primary" visible="false">
                            <b>
        ...
        <div class="container table-responsive">
            <asp:GridView ID="GvTickets" runat="server" Width="100%"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="totalGainAmount" HeaderText="Ganado" SortExpression="Ganado" />

                    <asp:ButtonField ImageUrl="/Content/bootstrap-icons/icons/card-list.svg" Text="" CommandName="Update" HeaderText="Detalle" ButtonType="Image">
