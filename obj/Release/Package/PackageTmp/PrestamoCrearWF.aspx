    ...
    <form id="form1" runat="server">
                    ...
                    <div runat="server" class="modal-body" onload="CargarDetallePrestamo">
                        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                            <ContentTemplate>
                                <div class="container">
                                    <div class="row align-items-end">
                                        ...
                                        <div class="col-6 col-md-6">
                                            ...
                                            <asp:TextBox ID="TbAgogadoD" ReadOnly="true" type="text" runat="server" class="form-control" placeholder="0.00"></asp:TextBox>
                                        </div>
                                        <div class="col-6 col-md-6">
                                        ...
                                        <div class="container table-responsive">
                                            ...
                                            <asp:GridView ID="GridViewAmortizacion" runat="server" Width="100%"
                                                ...
                                                DataKeyNames="QuotaNumber"
                                                EmptyDataText="No se encontraron datos entre los limites establecidos!"
                                                OnSelectedIndexChanged="GvDetallePrestamo_SelectedIndexChanged"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="QuotaNumber" HeaderText="Numero" ReadOnly="True" />

                                                    <asp:BoundField DataField="PayDate" HeaderText="Fecha de pago" Visible="false" />
                                ...
                                <br />
                                <div class="container table-responsive">
                                    <asp:GridView ID="GvDetallePrestamo" runat="server" Width="100%"
                                        CssClass="table table-responsive table-striped table-hover table-sm" AutoGenerateColumns="False"
                                        DataKeyNames="ID"
                                        EmptyDataText="No se encontraron datos entre los limites establecidos!"
                                        OnSelectedIndexChanged="GvDetallePrestamo_SelectedIndexChanged"
        ...
        <div class="container">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="row w-100">
                            <div class="col-5">
                                ...
                                <asp:TextBox ID="TbInteres" type="text" ReadOnly="true" runat="server" class="form-control w-100" placeholder="0%"></asp:TextBox>
                            </div>
                            <div class="col-5">
                                <label for="LbCuota" class="form-label">Cuota</label>
                                <asp:TextBox ID="TbCuota" type="number" runat="server" class="form-control w-100" placeholder="0.00"></asp:TextBox>
                            </div>
                        ...
                        <div class="row w-100">
                            <div class="col-6">
                                <asp:CheckBox ID="CbInteres" runat="server" TextAlign="Left" Text="Interes" Enabled="false"/>
                            </div>
                            <div class="col-6">
                                <asp:CheckBox ID="CbCuota" runat="server" Checked="true" TextAlign="Left" Text="Monto" Enabled="false" />
                            </div>
                        </div>
            ...
            <div class="col container">
                ...
                <button type="button" class="btn btn-primary float-end" data-bs-toggle="modal" data-bs-target="#exampleModalDetallePrestamo">
                    <b>
                        <img src="/Content/bootstrap-icons/icons/search.svg" alt="Bootstrap" width="22" height="22" /><i>
                                Procesar</i></b>
                </button>
